                                            ...
                                            <table align="center">
                                               ...
                                               <td style="color:#666;padding:15px; padding-bottom:0;font-size:14px;line-height:20px;font-family:arial;text-align:left">
                                                    ...
                                                    <div style="font-style:normal;padding-bottom:15px;font-family:arial;line-height:20px;text-align:left">
                                                        ...
                                                        <p> Hola <span style="font-weight:bold;color:#4296CE;font-size:16px">'.$sendername.'</span>
                                                        
														hemos recibido su mensaje y le agradecemos que se tome su tiempo para comunicarse con nosotros, volveremos
                                                        para ti lo antes posible </p>
														
														<p style="border-bottom:1px solid #D8D8D8; height:0; color:#666;text-align:center;padding:15px 0 0 0"></p>
														<p style="margin-top:20px;">Para más consultas, utilice su correo electrónico a continuación</p>
														<p><span style="font-weight:bold;font-size:13px">Nuestro correo para contacto:</span> 
                                ...
                                <tbody>
                                    <tr>
                                        <td style="color:#b4b4b4;font-size:11px;padding-top:10px;line-height:15px;font-family:arial">
                                            <span> &copy; ELFLAIRE 2014 - '.$currYear.' -   TODOS LOS DERECHOS RESERVADOS </span>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
